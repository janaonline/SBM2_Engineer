...
//    TextView feedback;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        AppController.getInstance().assignLanguage(ComplaintDetailNew.this);
...
//        frameLoading.setVisibility(View.GONE);
        ...
        final String url = URLData.BASE_URL
                ...
                ComplaintDetailNew.this, ICMyCPreferenceData.id,
                "");
...
//        setOffsetChangeListenerWhileScroll();
        ...
        ParseComplaintData.getInstance().setImage(activity, null, locationImage,
                URLDataSwachhManch.MAP_THUMBNAIL.replace("<COORDINATES>",
                        complaintDetailData.getLatitude() + "," + complaintDetailData.getLongitude()), false);
        ...
        complaintLocation.setOnClickListener(view -> {
            String uri = String.format(
                    Locale.ENGLISH,
                    "geo:0,0?q=" + AppController.getInstance().selectedComplaintData.getLatitude() + ","
                            + AppController.getInstance().selectedComplaintData.getLongitude() + "&z=16 ("
                            + getResources().getString(R.string.app_name) + " complaint location" + ")");
...
//                complaintDetailData.getLatitude() + "," + complaintDetailData.getLongitude());
        ...
        voted_up.setText(complaintDetailData.getVote_up_count());
        comment.setText(complaintDetailData.getComment_count());
    ...
    private class SetListData extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            cStatusListData = AppController.customizeListData(
                    ComplaintDetailNew.this, cStatusListData);
            return null;
        }
