...
//                        runtimePermissionManager(mContext, permissionsRequired, new GetPermissionResult() {
//                            @Override
//                            public void resultPermissionSuccess() {
//                                Toast.makeText(mContext, "Thanks for allowing permissions", Toast.LENGTH_SHORT).show();
//
//
//                            }
//
