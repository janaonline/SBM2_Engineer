...
public class URLDataConstants {
    private static com.ichangemycity.webservice.URLDataConstants mInstance;

    public static com.ichangemycity.webservice.URLDataConstants getInstance() {
        return mInstance == null ? mInstance = new com.ichangemycity.webservice.URLDataConstants() : mInstance;
    }
